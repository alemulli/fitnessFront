...
//Menu that allows you to create a new routine
      ...
      <div className="addRoutineMenu">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            type="text"
            onChange={(e) =>
              setRoutineInfo({ ...routineInfo, goal: e.target.value })
            }
            value={routineInfo.goal}
            required
          />
          <br />
          ...
          <input
            id="isPublic"
            type="checkbox"
            checked={routineInfo.isPublic}
            onChange={(e) =>
              setRoutineInfo({
                ...routineInfo,
                isPublic: !routineInfo.isPublic,
              })
            }
          />
          <br />
